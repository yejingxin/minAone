...
#include "two_compartmentminAone_nlp.hpp"
#include <cmath>
#include <cstdio>
#include <iostream>
#include <fstream>
...
// constructor
TWO_COMPARTMENT_NLP::TWO_COMPARTMENT_NLP(int id)
{
  nU=0;
  nP=0;
  nY=7;
...
// destructor
TWO_COMPARTMENT_NLP::~TWO_COMPARTMENT_NLP()
{
  delete [] K11val;
  delete [] K11val2;
  delete [] K11valp1;
...
bool TWO_COMPARTMENT_NLP::changeRf(){
...
bool TWO_COMPARTMENT_NLP::get_nlp_info(Index& n, Index& m, Index& nnz_jac_g,
...
bool TWO_COMPARTMENT_NLP::get_bounds_info(Index n, Number* x_l, Number* x_u,
...
bool TWO_COMPARTMENT_NLP::get_starting_point(Index n, bool init_x, Number* x,
...
bool TWO_COMPARTMENT_NLP::eval_f(Index n, const Number* x, bool new_x, Number& obj_value)
{
  assert(n == 14*Time+7);
  obj_value = 0;
...
bool TWO_COMPARTMENT_NLP::eval_grad_f(Index n, const Number* x, bool new_x, Number* grad_f)
{
  assert(n == 14*Time+7);
...
bool TWO_COMPARTMENT_NLP::eval_g(Index n, const Number* x, bool new_x, Index m, Number* g)
{
  assert(n == 14*Time+7);
  assert(m == 0);
...
bool TWO_COMPARTMENT_NLP::eval_jac_g(Index n, const Number* x, bool new_x,
...
bool TWO_COMPARTMENT_NLP::eval_h(Index n, const Number* x, bool new_x,
...
void TWO_COMPARTMENT_NLP::finalize_solution(SolverReturn status,
